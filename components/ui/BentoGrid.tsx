  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: 'linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(5,5,111,1) 100%, rgba(0,212,255,1) 100%)'
      }}
    >
      ...
      <div className={`${id===6 } && 'flex justify-center' h-full'`}>
        ...
        <div className={`absolute right-0 -bottom-5 ${id
          === 5 && 'w-full placeholder-opacity-80'
        }`}>
          {spareImg &&(
            <img 
              src={spareImg}
        ...
        {id===3 && (
          <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2 "> 
            <div className="flex flex-col gap-3 lg:gap-8">
              {['Python','HTML','CSS','React.js,', 'VSCode',].map((item)=>(
        ...
        {id ===6 && (
          <div className="mt-5 relative lg:col-span-2" >
